...
var require_acorn = __commonJS({
  "../../node_modules/acorn/dist/acorn.js"(exports, module2) {
    (function(global, factory) {
      ...
      var literal2 = /^(?:'((?:\\.|[^'\\])*?)'|"((?:\\.|[^"\\])*?)")/;
      pp2.strictDirective = function(start3) {
        for (; ; ) {
      ...
      pp$12.parseStatement = function(context, topLevel, exports3) {
        ...
        switch (starttype) {
          ...
          case types2._import:
            ...
            return starttype === types2._import ? this.parseImport(node2) : this.parseExport(node2, exports3);
          default:
      ...
      pp$12.parseClassElement = function(constructorAllowsSuper) {
        ...
        var tryContextual = function(k, noLineBreak) {
          if (noLineBreak === void 0)
            noLineBreak = false;
          var start3 = this$1.start, startLoc = this$1.startLoc;
          ...
          method.key = this$1.startNodeAt(start3, startLoc);
          method.key.name = k;
      ...
      pp$12.parseExport = function(node2, exports3) {
        this.next();
        if (this.eat(types2.star)) {
          if (this.options.ecmaVersion >= 11) {
            if (this.eatContextual("as")) {
              node2.exported = this.parseIdent(true);
              this.checkExport(exports3, node2.exported.name, this.lastTokStart);
            } else {
              node2.exported = null;
            }
          }
        ...
        if (this.shouldParseExportStatement()) {
          ...
          if (node2.declaration.type === "VariableDeclaration") {
            ...
            this.checkExport(exports3, node2.declaration.id.name, node2.declaration.id.start);
          }
          node2.specifiers = [];
          node2.source = null;
        } else {
      ...
      pp$12.checkExport = function(exports3, name2, pos) {
        if (!exports3) {
          return;
        }
      ...
      pp$12.parseExportSpecifiers = function(exports3) {
        ...
        while (!this.eat(types2.braceR)) {
          ...
          this.checkExport(exports3, node2.exported.name, node2.exported.start);
      ...
      pp$32.parseSubscripts = function(base2, startPos, startLoc, noCalls) {
      ...
      pp$32.parseSubscript = function(base2, startPos, startLoc, noCalls, maybeAsyncArrow, optionalChained) {
      ...
      pp$32.parseExprAtom = function(refDestructuringErrors) {
        ...
        switch (this.type) {
          ...
          case types2.parenL:
            var start3 = this.start, expr = this.parseParenAndDistinguishExpression(canBeArrow);
            if (refDestructuringErrors) {
      ...
      exports2.keywordTypes = keywords$12;
      ...
      exports2.tokContexts = types$12;
      exports2.tokTypes = types2;
...
// ../../node_modules/mdast-util-to-hast/node_modules/mdast-util-definitions/lib/index.js
...
function defaultUnknownHandler(state, node2) {
  ...
  const result = "value" in node2 && !(own6.call(data2, "hProperties") || own6.call(data2, "hChildren")) ? { type: "text", value: node2.value } : {
    type: "element",
    tagName: "div",
    properties: {},
      ...
      enter(node2) {
        ...
        if (currentScope && node2.type === "JSXElement") {
          ...
          if (name2.type === "JSXMemberExpression") {
            ...
            if (!own7.call(fnScope.references, fullId)) {
              const parentScope = (
                /** @type {Scope | undefined} */
                currentScope.parent
              );
            ...
            if (!inScope(currentScope, id)) {
              if (id !== "MDXLayout" && !own7.call(fnScope.references, id)) {
      ...
      leave(node2) {
        ...
        if (node2.type === "FunctionDeclaration" || node2.type === "FunctionExpression" || node2.type === "ArrowFunctionExpression") {
          ...
          for (key in scope.references) {
            if (own7.call(scope.references, key)) {
              const parts = key.split(".");
              let index3 = 0;
              while (++index3 < parts.length) {
                const partial = parts.slice(0, index3).join(".");
                if (!own7.call(scope.references, partial)) {
  ...
  */
  Program(node2, state) {
    ...
    if (writeComments && node2.comments != null) {
      formatComments(state, node2.comments, indent, lineEnd);
    }
    ...
    if (writeComments && node2.trailingComments != null) {
      formatComments(state, node2.trailingComments, indent, lineEnd);
    }
  },
    ...
    if (own9.call(props, prop)) {
      ...
      if (prop === "style") {
        ...
        for (cssProp in styleObject) {
          if (own9.call(styleObject, cssProp)) {
            cssProperties.push({
              type: "Property",
              method: false,
              shorthand: false,
...
function zwitch(key, options) {
  ...
  function one3(value, ...parameters) {
    ...
    if (value && own11.call(value, key)) {
      ...
      fn = own11.call(handlers3, id) ? handlers3[id] : one3.unknown;
    }
    if (fn) {
